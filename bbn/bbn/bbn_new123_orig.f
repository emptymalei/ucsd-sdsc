...
C----------PARAMETERS.
      ...
      PARAMETER (iw=6)             !Output unit number (previous value = 1).
      PARAMETER (nnuc=26)          !Number of nuclides in calculation.
      PARAMETER (itmax=400)         !Maximum # of line to be printed.
...
C----------PARAMETERS.
      ...
      PARAMETER (nnuc=26)          !Number of nuclides in calculation.
      PARAMETER (itmax=400)         !Maximum # of lines to be printed.
...
C10--------OPEN FILE------------------------------------------------------------
      ...
      IF (itime.eq.1) THEN         !Beginning of program.
        OPEN (unit=3, file='newint.dat',  status='unknown')
      END IF
...
C-----------DEFAULT VARIATIONAL PARAMETERS.
      ...
      DATA eta0   /6.11e-10/      !Default baryon-to-photon ratio.
