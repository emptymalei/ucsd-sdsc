...
\subsection{Publications using \code{GR1D} and/or its EOS tables}
\begin{itemize}
\item {\bf {Equation of state effects in black hole-neutron star
    mergers}}, Duez, Matthew D.; Foucart, Francois; Kidder, Lawrence
  E.; Ott, Christian D.; Teukolsky, Saul A., Class. Quantum Grav., 2010
  27 114106

\item {\bf{Determining the main-sequence mass of Type II supernova
    progenitors}} Dessart, Luc; Livne, Eli; Waldman, Roni, MNRAS,
  2010, 408 827
\item {\bf{ Studies of Stellar Collapse and Black Hole Formation with
    the Open-Source Code GR1D}} Ott, C.D.; O'Connor, E., THE 10TH
  INTERNATIONAL SYMPOSIUM ON ORIGIN OF MATTER AND EVOLUTION OF
  GALAXIES: OMEG-2010. AIP Conference Proceedings, 2010, 1269 166
\item {\bf{Black Hole Formation in Failing Core-Collapse Supernovae}},
  O'Connor, E. and Ott, C.D., submitted to the Astrophysical Journal,
  arXiv:1010.5550
\end{itemize}
